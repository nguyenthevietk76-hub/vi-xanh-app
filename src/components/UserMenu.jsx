  ...
  if (!user) {
    return (
      <button
        ...
        className="hidden sm:inline-flex items-center gap-2 px-space-lg py-space-xs bg-surface-container-lowest border border-outline-variant text-primary hover:bg-surface-container-low rounded-chip text-label-lg font-semibold transition-all shadow-subtle"
      >
    ...
    <div className="flex items-center gap-space-xs">
      ...
      <div className="relative" ref={notifRef}>
        <button
          ...
          className="relative w-9 h-9 rounded-full flex items-center justify-center text-on-surface-variant hover:bg-surface-container-high transition-colors"
          title="Thông báo"
          aria-label="Thông báo"
        >
          <span className="material-symbols-outlined text-[22px]">notifications</span>
          {unreadCount > 0 && (
            <span className="absolute top-1 right-1 min-w-[18px] h-[18px] px-1 bg-red-500 text-white rounded-full text-[10px] font-bold flex items-center justify-center shadow-subtle animate-pulse">
        ...
        {notifOpen && (
          <div className="absolute right-0 mt-2 w-80 sm:w-96 bg-surface-container-lowest border border-outline-variant rounded-card shadow-level-2 py-2 z-50 overflow-hidden">
